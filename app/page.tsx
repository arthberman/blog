        ...
        <section className="mb-12">
          ...
          <div className="space-y-4 text-sm leading-relaxed text-zinc-600">
            ...
            <p>
              ...
              , an AI that drafts emails in your tone. Now I'm relocating to San
              Francisco.
            </p>
              ...
              <li key={article.slug}>
                <Link href={`/blog/${article.slug}`} className="group block">
                  <article className="flex items-center justify-between">
                    <h3 className="font-[family-name:var(--font-sans)] text-sm text-zinc-900 group-hover:text-zinc-600">
                      {article.title}
                    </h3>
